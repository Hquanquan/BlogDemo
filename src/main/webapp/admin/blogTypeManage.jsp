...
<script type="text/javascript">
	...
	function deleteBlogType(){
		...
		$.messager.confirm("系统提示","<font color=red>您确定要删除选中的"+selectedRows.length+"条数据么？</font>", 
				function(r) {
					if(r){
...
<body style="margin:1px;font-family:microsoft yahei">
 		...
 		<form id="fm" method="post">
 			<table cellspacing="8px">
 				...
 				<tr>
 					...
 					style="width:50px"/>&nbsp;(博客类别会根据序号从小到大排列)
 					</td>
 				</tr>
 			</table>
 		</form>
	...
	<div id="dlg-buttons">
		<div>
			...
			<a href="javascript:closeBlogTypeDialog()" class="easyui-linkbutton"
